...
class Pedido extends Sistema
{
    public function leer()
    {
        ...
        $sql = "SELECT p.*, u.nombre, u.primer_apellido, u.segundo_apellido, mp.metodo_pago
                FROM pedido p
    ...
    public function leerUno($id_pedido)
    {
        ...
        $sql = "SELECT p.*, u.nombre, u.primer_apellido, u.segundo_apellido, u.correo, mp.metodo_pago
                FROM pedido p
                INNER JOIN usuario u ON p.id_usuario = u.id_usuario
                LEFT JOIN metodo_pago mp ON p.id_metodo_pago = mp.id_metodo_pago
        ...
        try {
            ...
            foreach ($carrito as $item) {
                ...
                if ($productoBD['stock'] < $item['cantidad']) {
                    throw new Exception("Stock insuficiente para el producto: " . $productoBD['producto']);
                }
